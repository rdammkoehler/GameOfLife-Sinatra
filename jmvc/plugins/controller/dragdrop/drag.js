...
},
{
    draw : function(pointer, event){
         ...
         */
        if(!this._horizontal)    this.movingElement.css("top", this.required_css_position.top() + "px");
        if(!this._vertical)      this.movingElement.css("left", this.required_css_position.left() + "px");
